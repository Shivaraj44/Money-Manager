...
class MayActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val option = arrayOf("May","Feb","Jan","Mar","Apr")
        ...
        spinner_Apr.onItemSelectedListener = object : AdapterView.OnItemClickListener,
            ...
            override fun onItemSelected(
                ...
                if (position == 1) {
                    val intent= Intent(this@MayActivity, FebActivity::class.java)
                    startActivity(intent)
                }else if(position==2){
                    val intent= Intent(this@MayActivity, HomeActivity2::class.java)
                    startActivity(intent)

                }
                else if(position==3){
                    val intent= Intent(this@MayActivity, MarActivity::class.java)
                    startActivity(intent)

                }
                else if(position==4){
                    val intent= Intent(this@MayActivity, AprActivity::class.java)
                    startActivity(intent)
